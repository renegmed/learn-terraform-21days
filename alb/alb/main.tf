...
resource "aws_lb" "my-aws-alb" {
  ...
  ip_address_type    = "ipv4"   # not dualstack(ipv4+ipv6)
  load_balancer_type = "application"   # this is application load balancer, not network load balancer or classic network balancer ()
}
